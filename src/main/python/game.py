...
def soul(focus: int = 1, play_mode: bool = True, exec_count: int = 1, team_leader: bool = True, auto: bool = True,
    ...
    if dry_run:
        ...
        res_judge_rgb_team_ui = res_click_btn_team_start = res_judge_rgb_btn_battle_start = res_judge_rgb_battle_during_ui = res_judge_rgb_battle_ending_ui = res_click_area_battle_ending = (
            None, None)
    if play_mode:
        # 单人模式 无关是否队长
        while t_exec_count:
