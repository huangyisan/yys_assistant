...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_radio_leader_no.setGeometry(QtCore.QRect(100, 40, 89, 16))
        ...
        self.btn_radio_auto_no.setGeometry(QtCore.QRect(100, 80, 89, 16))
        ...
        self.checkbox_second_pos.setGeometry(QtCore.QRect(80, 40, 71, 16))
        ...
        self.checkbox_third_pos.setGeometry(QtCore.QRect(150, 40, 71, 16))
        ...
        self.checkbox_fourth_pos.setGeometry(QtCore.QRect(10, 60, 71, 16))
        self.checkbox_fourth_pos.setObjectName("checkbox_fourth_pos")
        self.buttonGroup_2.addButton(self.checkbox_fourth_pos)
        self.checkbox_sixth_pos = QtWidgets.QCheckBox(self.groupBox_5)
        self.checkbox_sixth_pos.setEnabled(False)
        self.checkbox_sixth_pos.setGeometry(QtCore.QRect(150, 60, 71, 16))
        self.checkbox_sixth_pos.setObjectName("checkbox_sixth_pos")
        self.buttonGroup_2.addButton(self.checkbox_sixth_pos)
        self.checkbox_fifth_pos = QtWidgets.QCheckBox(self.groupBox_5)
        self.checkbox_fifth_pos.setGeometry(QtCore.QRect(80, 60, 71, 16))
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(self.second_page)
        self.groupBox_6.setGeometry(QtCore.QRect(10, 230, 221, 61))
        self.groupBox_6.setObjectName("groupBox_6")
        self.label_4 = QtWidgets.QLabel(self.groupBox_6)
        self.label_4.setGeometry(QtCore.QRect(10, 20, 151, 16))
        self.label_4.setObjectName("label_4")
        self.btn_radio_open_yes = QtWidgets.QRadioButton(self.groupBox_6)
        self.btn_radio_open_yes.setGeometry(QtCore.QRect(10, 40, 89, 16))
        self.btn_radio_open_yes.setObjectName("btn_radio_open_yes")
        self.btn_radio_open_no = QtWidgets.QRadioButton(self.groupBox_6)
        self.btn_radio_open_no.setGeometry(QtCore.QRect(100, 40, 89, 16))
        ...
        self.btn_radio_reward_no.setGeometry(QtCore.QRect(100, 40, 89, 16))
        self.btn_radio_reward_no.setObjectName("btn_radio_reward_no")
        self.btn_start_soul = QtWidgets.QPushButton(self.second_page)
        self.btn_start_soul.setGeometry(QtCore.QRect(10, 390, 221, 23))
        self.btn_start_soul.setObjectName("btn_start_soul")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkbox_sixth_pos.setText(_translate("MainWindow", "六号"))
        self.checkbox_fifth_pos.setText(_translate("MainWindow", "五号"))
        self.label_3.setText(_translate("MainWindow", "左起式神焦点"))
        self.groupBox_6.setTitle(_translate("MainWindow", "战斗后"))
        ...
        self.btn_start_soul.setText(_translate("MainWindow", "开始挂机"))
