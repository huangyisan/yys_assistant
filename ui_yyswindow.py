...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_radio_left = QtWidgets.QRadioButton(self.widget)
        self.btn_radio_left.setObjectName("btn_radio_left")
        self.horizontalLayout_2.addWidget(self.btn_radio_left)
        self.btn_radio_right = QtWidgets.QRadioButton(self.widget)
        ...
        self.btn_config.setGeometry(QtCore.QRect(140, 130, 71, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_piexl.setText(_translate("MainWindow", "采集像素点rgb为"))
        self.btn_config.setText(_translate("MainWindow", "采点list"))
